...
function toggleLoading(isLoading) {
  const searchIcon = document.querySelector("#buttonSearch");

  if (isLoading) {
    searchIcon.firstElementChild.className = "fas fa-hourglass-half";
    searchIcon.lastElementChild.innerText = " Loading...";

    searchIcon.disabled = true;
  } else {
    searchIcon.firstElementChild.className = "fas fa-search";
    searchIcon.lastElementChild.innerText = " Search";
